...
export const createCategory = createAsyncThunk(
    "categories/create",
    async ({ categoryDto }: CategoryRequest, { rejectWithValue }) => {
        log.info("Attempting to create category");
        try {
            const client = new CategoryApiClient(axiosClient);
...
export const getAllCategories = createAsyncThunk(
    "categories/fetchAll",
    async ({ filter }: CategoryRequest, { rejectWithValue }) => {
...
export const updateCategory = createAsyncThunk(
    "categories/update",
    async ({ id, categoryDto }: CategoryRequest, { rejectWithValue }) => {
