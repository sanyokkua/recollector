...
import {jwtTokenExtractor, jwtTokenSaver} from "../store/browserStore.ts"

export const authApiClient = new AuthApiClient(axiosClient, jwtTokenExtractor, jwtTokenSaver);
